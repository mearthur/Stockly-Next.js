...
export const DeleteProductDialogContent = ({ productId }: DeleteProductDialogContentProps) => {
  ...
  return (
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          Você está prestes a ecluir este produto. Esta ação não pode ser desfeita. Deseja Continuar ?
        </AlertDialogDescription>
      </AlertDialogHeader>
      <AlertDialogFooter>
